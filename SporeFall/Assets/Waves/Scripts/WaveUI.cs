...
public class WaveUI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        wave1Bar.maxValue = waveManager.waves[1].totalEnemies;
        wave2Bar.maxValue = waveManager.waves[2].totalEnemies;
        wave3Bar.maxValue = waveManager.waves[3].totalEnemies;
